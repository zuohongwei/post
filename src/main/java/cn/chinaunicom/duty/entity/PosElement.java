...
@ApiModel("")
public class PosElement extends Model<PosElement> {
	...
	public String toString() {
		return "PosElement{" + ", elementId=" + elementId + ", elementCode=" + elementCode + ", elementName=" + elementName + ", elementType=" + elementType + ", dateFrom=" + dateFrom + ", dateTo="
				+ dateTo + ", createdBy=" + createdBy + ", creationDate=" + creationDate + ", lastUpdatedBy=" + lastUpdatedBy + ", lastUpdateDate=" + lastUpdateDate + ", attribute1=" + attribute1
				+ ", attribute2=" + attribute2 + ", attribute3=" + attribute3 + ", attribute4=" + attribute4 + ", attribute5=" + attribute5 + ", attribute6=" + attribute6 + ", attribute7="
				+ attribute7 + ", attribute8=" + attribute8 + ", attribute9=" + attribute9 + ", attribute10=" + attribute10 + ", attribute11=" + attribute11 + ", attribute12=" + attribute12 + "}";
	}
}
