...
public class MyBatisPlusGenerator {
	...
	private static String	packageName	= "postionmanagement";									// 文件路径
	private static String	authorName	= "wangrunpu";									// 作者
	private static String	table		= "ehrcuc_pos_tree_v";				// table名字
	private static String	prefix		= "hr_";										// table前缀
	private static File		file		= new File("");
	private static String	path		= file.getAbsolutePath();
	private static String	DB_URL		= "jdbc:mysql://10.10.14.13:3306/test?characterEncoding=utf8";
		...
		AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
				...
				.setDataSource(
						...
						new DataSourceConfig().setDbType(DbType.MYSQL)// 数据库类型
								...
								}).setDriverName(DB_DRIVER).setUsername(DB_USER).setPassword(DB_PASSWORD).setUrl(DB_URL))
				.setStrategy(
						// 策略配置
						new StrategyConfig()
				...
				// .setControllerMappingHyphenStyle(true)
						...
						new PackageConfig()
								// .setModuleName("User")
								.setParent("cn.chinaunicom." + packageName)// 自定义包路径
				...
				// .setXml("mapper")
						...
						new InjectionConfig() {
							...
							public String outputFile(TableInfo tableInfo) {
								return path + "/src/main/java/cn/chinaunicom/servicecfg/dao/xml" + tableInfo.getEntityName() + "Mapper.xml";
							}
						})))
				.setTemplate(
